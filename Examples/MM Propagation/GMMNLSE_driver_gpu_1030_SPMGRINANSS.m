% This script simulates nonlinear propagation in GRIN fiber, with all terms
% except Raman and self-steepening.
...
% propagation
save_name = make_test_save_name(['GRIN_1030_SPMGRINANSS'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1030_SPMGRINANSS'], sim);
