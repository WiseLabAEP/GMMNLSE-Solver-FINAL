% This script simulates generation of 1300-nm pulses in GRIN fiber with 17
% modes, via self-phase modulation with normal dispersion
...
num_modes = 17; % The number of modes to be simulated. 
...
prefix = '../../Fibers/GRIN_1030';
load([prefix '/S_tensors_' num2str(num_modes) 'modes.mat']); % [m^-2]
load([prefix '/betas_many.mat']); % [fs^n/mm]
...
% propagation
save_name = make_test_save_name(['GRIN_1030_SPMGRINAHMM'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1030_SPMGRINAHMM'], sim);
