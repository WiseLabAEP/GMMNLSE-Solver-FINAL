...
load_name = make_test_save_name([pwd '\GRIN_1550_MMS_XPMNSSHR1'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1550_MMS_XPMNSSHR'], sim)
load(load_name)
...
load_name = make_test_save_name([pwd '\GRIN_1550_MMS_XPMNSSHR2'], sim);
load(load_name)
