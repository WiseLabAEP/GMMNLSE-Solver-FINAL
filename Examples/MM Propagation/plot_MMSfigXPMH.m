...
load_name = make_test_save_name([pwd '\GRIN_1550_MMS_XPMH1'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1550_MMS_XPMH'], sim);
load(load_name)
...
load_name = make_test_save_name([pwd '\GRIN_1550_MMS_XPMH2'], sim);
load(load_name)
