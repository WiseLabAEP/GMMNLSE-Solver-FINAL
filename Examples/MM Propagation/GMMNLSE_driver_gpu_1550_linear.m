% This script simulates linear propagation in GRIN fiber at 1550 nm
...
sim.deltaZ = 500e-6; % The step size in m. This may need to be 1-50 um to account for intermodal beating, even if the nonlinear length is much larger than 50 um
...
% propagation
save_name = make_test_save_name(['GRIN_1550_linear2'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1550_linear2'], sim);
...
total_energy = 0.000001; % nJ, total energy of the initial pulse. By convension this is the total energy in all modes
