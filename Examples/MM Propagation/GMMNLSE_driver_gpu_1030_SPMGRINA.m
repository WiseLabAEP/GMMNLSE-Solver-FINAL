% This script simulates generation of 1300-nm pulses in GRIN fiber, via
...
% propagation
save_name = make_test_save_name(['GRIN_1030_SPMGRINA'], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1030_SPMGRINA'], sim);
