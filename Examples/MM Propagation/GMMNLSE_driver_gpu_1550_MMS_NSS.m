...
% propagation
save_name = make_test_save_name(['GRIN_1550_MMS_NSS' num2str(idx)], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1550_MMS_NSS' num2str(idx)], sim);
