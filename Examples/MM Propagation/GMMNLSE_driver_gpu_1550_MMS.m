...
% 1550 nm. The original script was converted here into function form to
% more easily run multiple simulations in sequence

function GMMNLSE_driver_gpu_1550_MMS(TFWHM,idx)
...
% propagation
save_name = make_test_save_name(['GRIN_1550_MMS' num2str(idx)], sim);
savepath = make_test_save_name([pwd '\plots\GRIN_1550_MMS' num2str(idx)], sim);
